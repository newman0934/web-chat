...
- ✅ ~~建群後加入 / 移除成員、退出群組~~ —— 已於 2026-06-21 實作，見 [群組管理設計](2026-06-21-group-management-design.md)。
- ✅ ~~群組改名 / 設定~~ —— 已於 2026-06-21 實作，見 [群組管理設計](2026-06-21-group-management-design.md)。
- ✅ ~~管理員角色 / 權限~~ —— 已於 2026-06-21 實作，見 [群組管理設計](2026-06-21-group-management-design.md)。
- ✅ ~~用 email 加非好友進群（只能加好友）~~ —— 已於 2026-06-21 實作，見 [群組管理設計](2026-06-21-group-management-design.md)。
